<template>
  <div>
    <el-popover :width="250" placement="right" trigger="hover" offset="-30" hide-after="100">
      <template #reference>
        <!-- 用户没有头绪就显示图标 -->
      ...
      <template #default>
        <el-row style="margin-bottom: 0">
          <el-col :span="9" style="margin-bottom: 0">
            <div  class="icon-box" style="margin-bottom: 0" v-if="userIconSrc == ''">
          <svg
            t="1644432695605"
            class="icon"
            viewBox="0 0 1024 1024"
            ...
            xmlns="http://www.w3.org/2000/svg"
            p-id="3022"
            :width="userIconWidth+10"
            :height="userIconHeight+10"
          >
            <path
              d="M1024 544c0 265.12-214.944 480-480 480h-64C214.912 1024 0 809.12 0 544v-64C0 214.912 214.912 0 480 0h64c265.056 0 480 214.912 480 480v64z"
              fill="#376fbd"
        ...
        <div  style="margin-bottom: 0" class="icon-box" v-else>
          <div
            :style="{
              width: userIconWidth+10 + 'px',
              height: userIconHeight+10 + 'px',
              background: 'no-repeat 0% 0%',
              backgroundImage: `url(${userIconSrc})`,
              backgroundSize: '100% 100%',
              borderRadius: '50%',
          ...
          <el-col :span="15" style="margin-bottom: 0">
            <p style="font-size: 18px; margin-bottom:0; font-weight:800 ">{{ userName }}</p>
          </el-col>
        </el-row>
...
export default {
  name: "HeadIcon",
  props: ["userName", "userIconSrc", "userIconWidth", "userIconHeight","userInfor"],
};
</script>
